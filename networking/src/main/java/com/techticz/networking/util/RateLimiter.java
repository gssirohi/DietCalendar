package com.techticz.networking.util;
...
/**
 * Utility class that decides whether we should fetch some data or not based on given timeout.
 */
public class RateLimiter<KEY> {
    ...
    public synchronized boolean isDataStale(KEY key) {
